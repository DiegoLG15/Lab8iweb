      ...
      <div class="card-body">
        ...
        <table class="table table-striped table-hover">
          ...
          <tr style="align-content: center">
            ...
            <th style="color:#053934; padding-left: 2rem; text-align: center"><b>EXPERIENCIA</b></th>
            <th style="color:#053934; padding-left: 2rem; text-align: center" ><b>OBJETO PERDIDO</b></th>
            <th style="color:#053934; padding-left: 2rem; text-align: center"><b>PROBABILIDAD</b></th>
          ...
          <tr style="align-content: center">
            ...
            <td style="padding-left: 2rem; text-align: center">
              <%=enemigo.getExperienciaxDerrota()%>
            </td>
            <td style="padding-left: 2rem; text-align: center">
              <%=enemigo.getObjetoDejado()%>
            </td>
            <td style="padding-left: 2rem; text-align: center">
            ...
            <td >
              ...
              <a type="button" class="btn btn-primary"
                 href="<%=request.getContextPath()%>/MenuServlet?accion=editarEnemigo&id=<%=enemigo.getIdEnemigo()%>">
              ...
              <a type="button" class="btn btn-danger"
                 onclick="return confirm('¿Estas seguro(a) que deseas eliminar?')"
                 href="<%=request.getContextPath()%>/MenuServlet?accion=borrarEnemigo&id=<%=enemigo.getIdEnemigo()%>">
