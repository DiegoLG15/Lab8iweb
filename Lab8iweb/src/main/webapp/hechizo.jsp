  ...
  <body data-spy="scroll" data-target="#navbar-nav-header" class="static-layout">
    ...
    <div class="d-flex justify-content-center">
      <div class="card"  style="background-color: rgba(240,240,240,0.6)">
        <div class="card-body">
          <div>
            <h4 style="text-align: center; color: black"><b>LISTA DE HECHIZOS</b></h4>
          </div>
          <div class="d-grid gap-2 d-md-flex justify-content-md-end">
            <a class="btn btn-danger" href="<%=request.getContextPath()%>/MenuServlet?accion=crearHechizo"
          ...
          <table class="table table-striped table-hover">
            <thead>
              <tr style="align-content: center">
                ...
                <th style="color:#053934; padding-left: 2rem; text-align: center"><b>ELEMENTO</b></th>
                <th style="color:#053934; padding-left: 2rem; text-align: center"><b>POTENCIA</b></th>
                <th style="color:#053934; padding-left: 2rem; text-align: center"><b>PRECISIÓN</b></th>
                <th style="color:#053934; padding-left: 2rem; text-align: center"><b>HECHIZO BASE</b></th>
                <th style="color:#053934; padding-left: 2rem; text-align: center"><b>NIVEL DE APRENDIZAJE</b></th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <%=hechizo.getPrecisionDeHechizo()%>
                </td>
                <td>
                  <%=hechizo.getHechizoBase()%>
                </td>
                <td>
                  <%=hechizo.getNivelAprendizaje()%>
                </td>
                <td>
                  ...
                  <a type="button" class="btn btn-danger"
                     ...
                     href="<%=request.getContextPath()%>/MenuServlet?accion=borrarHechizo&id=<%=hechizo.getIdHechizo()%>">
