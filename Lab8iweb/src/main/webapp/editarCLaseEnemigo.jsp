...
<html lang="en">
<%
    ArrayList<ElementoClase> listafd = (ArrayList<ElementoClase>) request.getAttribute("fd");
%>
<head>
    <meta charset="utf-8">
    ...
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                <h2><li><a href="#" class="nav-link px-2"><b style="color:#144C47">WIKI FANTASIA</b></a></li></h2>
            </ul>
        </div>
    </div>
</header>
...
<div class="d-flex justify-content-center">
    <div class="card">
        <div class="card-body">
            <div >
                <center>
                    <h4><b style="color:#144C47">INFORMACION DE LA CLASE </b></h4>
                </center>
            </div>
            <table class="table table-striped table-hover">
                <thead>
                <tr style="align-content: center">
                    <th style="color:#053934; padding-left: 2rem; text-align: center" ><b>ELEMENTOS </b></th>
                    <th style="color:#053934; padding-left: 2rem; text-align: center" ><b>PORCENTAJE DE DAÑO</b></th>
                    <th style="color:#053934; padding-left: 2rem; text-align: center" ><b>FORTALEZA/DEBILIDAD</b></th>
                    <th style="color:#053934; padding-left: 2rem; text-align: center" ><b>EDITAR DAÑO</b></th>
                </tr>
                </thead>
                <%

                    for (ElementoClase elementoClase : listafd) {
                %>
                <th class="text-center" scope="row"><%= elementoClase.getNombreElemento()%></th>
                <td class="text-center"><%= elementoClase.getDaño()*100+"%"%></td>
                <td class="text-center"><%= elementoClase.getFd()%></td>
