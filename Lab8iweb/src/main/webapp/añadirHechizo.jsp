        ...
        <div class="container-fluid " style="background-color: rgba(255,255,255,0.6);width: 65%">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <td>
                <br><br><br>
                <img src="https://cdnb.artstation.com/p/assets/images/images/025/147/925/large/seo-eaglesage-11012020-ext-temple-3-1.jpg?1584801782" class="rounded mx-auto d-block " alt="userphoto" height="380rem" width="300rem">
              </td>
            </div>
            <div class="col-md-6">
              <form  method="post" action="<%=request.getContextPath()%>/MenuServlet?accion=guardarHechizo" class="row g-3">
                <td style="padding-left: 2rem;">
                  ...
                  <ul class="list-group list-group-flush">
                    ...
                    <input required type="number" min="1"  class="form-control" id="potenciaDeHechizo" placeholder="potenciaDeHechizo"
                           name="potenciaDeHechizo" >
                  </ul>
                  <ul class="list-group list-group-flush">

                    <label for="precisionDeHechizo" class="form-label">Precisión:</label>
                    <input required type="number" min="1"  class="form-control" id="precisionDeHechizo" placeholder="precisionDeHechizo"
                  ...
                  <ul class="list-group list-group-flush">
                    ...
                    <input required type="number" min="1" max="10" class="form-control" id="nivelAprendizaje" placeholder="nivelAprendizaje"
