...
<%@ page import="Daos.EnemigoDao" %>
<%
  ArrayList< Objeto > listaObjetos = (ArrayList< Objeto >) request.getAttribute("MenuDeObjetos");
  String claseComun = (String) request.getAttribute("claseEnemigoComun");
  String objetoComun = (String) request.getAttribute("ObjetoPerdidoComun");
  double enemigoGenero = (double) request.getAttribute("enemigoSinGenero");
%>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <br> <br>
  <main id="main">
    <div class="container-xxl bd-gutter mt-2 my-md-2 bd-layout">
      <aside class="bd-sidebar" style="width: 300px; height:450px; background-color: rgba(255,255,255,0.6)">
        <div id="region-menu-box">
          <div class="d-flex flex-column flex-shrink-0 p-3">
            <center>
              <h2 style="color:#144C47; font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif;"><b> ESTADISTICAS </b> </h2>
            </center>
            <center>
              <hr>
              <h6 style="color:#144C47; font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif;"><b>Clase de Enemigo mas utilizado </b> </h6>
              <hr>
              <h5 style="color:#144C47; font-family:'Berlin Sans FB', cursive, sans-serif;">
                <%= claseComun %>
              </h5>
            </center>
            <center>
              <hr>
              <h6 style="color:#144C47; font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif;"><b>Objeto Perdido mas comun </b> </h6>
              <hr>
              <h5 style="color:#144C47; font-family:'Berlin Sans FB', cursive, sans-serif;">
                <%= objetoComun %>
              </h5>
            ...
            <center>
              <hr>
              <h6 style="color:#144C47; font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif;"><b>Porcentaje de Enemigos Sin Genero</b> </h6>
              <hr>
              <h5 style="color:#144C47; font-family:'Berlin Sans FB', cursive, sans-serif;">
                <%= enemigoGenero %>
              </h5>
      ...
      <section class="section profile">
        <div class="container">
          <div class="container-fluid " style="background-color: rgba(255,255,255,0.6);width: 110%">
            <div class="row">
              <div >
                <br>
                <center>
                  <h3><b style="color:#144C47">EDITAR ENEMIGO</b></h3>
                </center>
                <br>
              </div>
              <div class="col-md-6">
              ...
              <div class="container">
                <div class="container-fluid " style="background-color: rgba(255,255,255,0.6);width: 65%">
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <form  method="post" action="<%=request.getContextPath()%>/MenuServlet?accion=guardarEnemigo" class="row g-3">
                        <td style="padding-left: 2rem;">
                          <ul class="list-group list-group-flush">
                            <label for="nombre" class="form-label"><b>NOMBRE:</b></label>
                            <input required pattern = "[A-Za-z]+" maxlength="10" type="text" class="form-control" id="nombre" placeholder="Nombre"
                                   name="nombre" >
                          </ul>
                          <ul class="list-group list-group-flush">
                          ...
                          <ul class="list-group list-group-flush">
                            ...
                            <input required pattern = "[0-9]+" type="number" min="1" class="form-control" id="ataque" placeholder="Ataque"
                                   name="ataque" >
                          </ul>
                          <ul class="list-group list-group-flush">

                            <label for="experienciaderrota" class="form-label"><b>EXPERIENCIA DERROTA:</b></label>
                            <input required pattern = "[0-9]+" type="number" min="8" max="999" class="form-control" id="experienciaderrota" placeholder="Experiencia Derrota"
                                   name="Experienciaderrota" >
                          </ul>
                          <ul class="list-group list-group-flush">

                            <label for="objetoperdido" class="form-label"><b>OBJETO PERDIDO:</b></label>
                            <select required class="form-select" id="objetoperdido" placeholder="objetoperdido" name="objetoperdido">
                              <option value="">Seleccione una opción</option>
                              <option value="0">Sin pareja</option>
                              <%for(Objeto objeto: listaObjetos){%>

                              <option value="<%=objeto.getIdobjeto()%>"><%= objeto.getIdobjeto()%>: <%=objeto.getObjeto() %></option>
                              <%}%>
                            </select>
                          </ul>
                          <ul class="list-group list-group-flush">

                            <label for="probabilidaddejarobjeto" class="form-label"><b>PROBABILIDAD DEJAR OBJETO:</b></label>
                            <input required step=0.01 type="number" min="1" max="100" class="form-control" id="probabilidaddejarobjeto" placeholder="Probabilidad Dejar Objeto"
                                   name="probabilidaddejarobjeto" >
                          </ul>
                          <ul class="list-group list-group-flush">
