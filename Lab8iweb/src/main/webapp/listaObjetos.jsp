                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr style="align-content: center">
                            ...
                            <td style="padding-left: 2rem; text-align: center"><%=objeto.getObjeto()%>
                            </td>
                            <td style="padding-left: 2rem; text-align: center"><%=objeto.getDescripcion()%>
                            </td>
                            <td style="padding-left: 2rem; text-align: center"><%=objeto.getPeso()%>
                            </td>
                            <td style="padding-left: 2rem; text-align: center"></td>
                            <td >
                                <center>
