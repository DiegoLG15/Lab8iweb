...
<%
    Hechizo hechizo = (Hechizo) request.getAttribute("hechizoEditar");
%>
<!DOCTYPE html>
<html lang="en">
    <head>
                    ...
                    <div class="container-fluid " style="background-color: rgba(255,255,255,0.6);width: 65%">
                        ...
                        <div class="row">
                            <div >
                                <center>
                                    <br>
                                    <h3><b style="color:#144C47">EDITAR HECHIZOS</b></h3>
                                    <br>
                                </center>
                            </div>
                            <div class="col-md-6">
                                <td>
                                    <br><br><br><br><br>
                                    <img src="https://w0.peakpx.com/wallpaper/440/402/HD-wallpaper-eventide-2-the-sorcerer-s-mirror05-hidden-object-cool-video-games-puzzle-fun.jpg" class="rounded mx-auto d-block " alt="userphoto" height="280rem" width="330rem">
                                </td>
                            </div>
                            <div class="col-md-6">
                                <form method="post" action="<%=request.getContextPath()%>/MenuServlet?accion=actualizarHechizo" class="row g-3">
                                    <td style="padding-left: 2rem;">
                                        <input maxlength="10" type="hidden" class="form-control" id="idHechizo" placeholder="idHechizo"
                                               name="idHechizo" value="<%=hechizo.getIdHechizo()%>">
                                        <ul class="list-group list-group-flush">

                                            <label for="nombreHechizo" class="form-label">Nombre:</label>
                                            <input type="text" class="form-control" id="nombreHechizo" placeholder="nombreHechizo"
                                                   name="nombreHechizo" value="<%=hechizo.getNombreHechizo()%>">
                                        </ul>

                                        <ul class="list-group list-group-flush">
                                            <label for="elemento" class="form-label">ELEMENTO:</label>
                                            <select required class="form-select" id="elemento" placeholder="elemento" name="elemento">
                                        ...
                                        <ul class="list-group list-group-flush">
                                            ...
                                            <label for="potencia" class="form-label"><b>Potencia:</b></label>
                                            <input type="number" min="1" class="form-control" id="potencia" placeholder="potencia"
                                                   name="potencia" value="<%=hechizo.getPotenciaDeHechizo()%>">

                                        </ul>
                                        <ul class="list-group list-group-flush">

                                            <label for="precision" class="form-label"><b>Precisión:</b></label>
                                            <input type="number" min="1" class="form-control" id="precision" placeholder="precision"
                                                   name="precision" value="<%=hechizo.getPrecisionDeHechizo()%>">

                                        </ul>
                                        <ul class="list-group list-group-flush">

                                            <label for="hechizoBase" class="form-label"><b>Hechizo base:</b></label>
                                            <input type="number" min="0" class="form-control" id="hechizoBase" placeholder="hechizoBase"
                                                   name="hechizoBase" value="<%=hechizo.getHechizoBase()%>">

                                        </ul>
                                        <ul class="list-group list-group-flush">

                                            <label for="nivelAprendizaje" class="form-label"><b>Nivel de aprendizaje:</b></label>
                                            <input type="number" min="1" max="10" class="form-control" id="nivelAprendizaje" placeholder="nivelAprendizaje"
                                                   name="nivelAprendizaje" value="<%=hechizo.getNivelAprendizaje()%>">
