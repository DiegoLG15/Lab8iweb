                ...
                <div class="container-fluid " style="background-color: rgba(255,255,255,0.6);width: 65%">
                    ...
                    <div class="row">
                        <div >
                            <br>
                            <center>
                                <h3><b style="color:#144C47">CREAR OBJETO</b></h3>
                            </center>
                            <br>
                        </div>
                        <div class="col-md-6">
                            <td><img
                                    src="https://cdnb.artstation.com/p/assets/images/images/031/262/015/large/seo-eaglesage-firemagecasuallsmall.jpg?1603114058"
                                    class="rounded mx-auto d-block " alt="userphoto" height="300rem" width="200rem">

                            </td>
                            <br>
                        </div>
                        <div class="col-md-6">
                            <form  method="post" action="<%=request.getContextPath()%>/MenuServlet?accion=guardarObjeto" class="row g-3">
                                <td style="padding-left: 2rem;">
                                    <ul class="list-group list-group-flush">
                                        <label for="Nombre" class="form-label"><b>Nombre:</b></label>
                                        <input required maxlength="45" type="text" class="form-control" id="Nombre" placeholder="Nombre"
                                               name="Nombre" >
                                    </ul>
                                    ...
                                    <ul class="list-group list-group-flush">
                                        ...
                                        <input required type="text" maxlength="150" class="form-control" id="Efecto/Uso" placeholder="Efecto/Uso"
                                               name="Efecto/Uso" >
                                    </ul>
                                    <ul class="list-group list-group-flush">

                                        <label for="Peso" class="form-label"><b>Peso:</b></label>
                                        <input required type="number" step="0.01" min="1" class="form-control" id="Peso" placeholder="Peso"
                                               name="Peso" >
                                    </ul>
