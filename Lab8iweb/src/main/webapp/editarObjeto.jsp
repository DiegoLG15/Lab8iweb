...
<%@ page import="Daos.ObjetoDao" %>
<%
    Objeto objeto = (Objeto) request.getAttribute("objetoEditar");
%>
<!DOCTYPE html>
<html lang="en">
    <head>
                    ...
                    <div class="container-fluid " style="background-color: rgba(255,255,255,0.6);width: 65%">
                        ...
                        <div class="row">
                            <div >
                                <center>
                                    <br>
                                    <h3><b style="color:#144C47">EDITAR OBJETO</b></h3>
                                    <br>
                                </center>
                            </div>
                            <div class="col-md-6">
                                <td>
                                    <img src="https://cdnb.artstation.com/p/assets/images/images/031/262/015/large/seo-eaglesage-firemagecasuallsmall.jpg?1603114058" class="rounded mx-auto d-block " alt="userphoto" height="600rem" width="380rem">
                                </td>
                            </div>
                            <div class="col-md-6">
                                <form method="post" action="<%=request.getContextPath()%>/MenuServlet?accion=actualizarObjeto" class="row g-3">
                                    <td style="padding-left: 2rem;">

                                        <ul class="list-group list-group-flush">

                                            <input maxlength="10" type="hidden" class="form-control" id="ID Objeto" placeholder="ID Objeto"
                                                   name="ID Objeto" value="<%=objeto.getIdobjeto()%>">
                                            <label for="Nombre" class="form-label" ><b> Nombre: </b></label>
                                            <input type="text" class="form-control" id="Nombre" placeholder="Nombre"
                                                   name="Nombre" value="<%=objeto.getObjeto()%>">

                                        </ul>

                                        <ul class="list-group list-group-flush">

                                            <label for="Efecto/Uso" class="form-label"><b>Efecto/Uso: </b></label>
                                            <input type="text" maxlength="150" class="form-control" id="Efecto/Uso" placeholder="Efecto/Uso"
                                                   name="Efecto/Uso" value="<%=objeto.getDescripcion()%>">
                                        </ul>
                                        <ul class="list-group list-group-flush">

                                            <label for="Peso" class="form-label"><b>Peso: </b></label>
                                            <input type="number" step="0.01" min="1" class="form-control" id="Peso" placeholder="Peso"
                                                   name="Peso" value="<%=objeto.getPeso()%>">
                                        </ul>
